...
class OtpRouter:
    """
    This class controls Django's DB functionality to ensure that all otp models get routed to the otp DB
    """
    ...
    def allow_relation(self, model1: Type[Model], model2: Type[Model], **hints: Dict[str, Any]) -> Optional[bool]:
        ...
        """
        return True if model1._meta.app_label == 'otp' and model2._meta.app_label == 'otp' else None
    ...
    def allow_migrate(self, db: str, app_label: str, model_name: str = None, **hints: Dict[str, Any]) -> Optional[bool]:
        ...
        """
        return True if app_label == 'otp' and db == 'otp' else None
